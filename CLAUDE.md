...
- การ์ดมี 4-5 ใบ: ผลหวยที่เพิ่งกรอก → วันนี้ถึงตอนนี้ → ตารางรายวันของเดือน (หวยนั้น) →
  ภาพรวมพอร์ต → ขาไหนบวก/ลบ · LINE จำกัด 12 ใบ และ JSON ~30 KB ⇒ `fitCarousel` ตัด
  วันเก่าของตารางออกเองถ้าใหญ่ไป **แล้วบอกบนการ์ดว่าตัด** ไม่ใช่หายเงียบ ๆ
