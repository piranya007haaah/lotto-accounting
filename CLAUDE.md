...
- ⚠️ **แท็บแก้ตั้งค่ามีแค่ 3 อย่างต่อขา: ชุดเลข · เรตจ่าย · เงินแทงต่อตัว** — ตั้งใจตัด
  เพิ่ม/ลบขา · เปลี่ยนหวย/ปี · เปลี่ยนสูตร/อันดับ · ชื่อพอร์ต/ทุน ออกทั้งหมด เพราะกองรวมกัน
  แล้วหาของที่แก้บ่อยจริง ๆ ไม่เจอ (ผู้ใช้บอกเองว่า "ซับซ้อนเกินไป") ของที่ตัดไปแก้ปีละครั้ง
  และยังทำได้ที่แอปเดิม — **อย่าเติมกลับโดยไม่มีคนขอ**
...
- ตาราง `lottery_datasets` มีแต่ขา **2 ตัว** (ฝั่งโน้นเก็บ 3 ตัวคนละตาราง ยังไม่ได้ย้ายมา)
