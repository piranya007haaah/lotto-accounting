...
/**
 * อ่านรูปหนึ่งใบสำหรับหน้า "อัปโหลดเป็นคู่"
 *
 * ต่างจาก /api/ocr ตรงที่ไม่ได้เหมาว่าทุกรูปเป็นสลิป — แยกก่อนว่าเป็นสลิปธนาคาร
 * หรือหน้าฝาก/ถอนของเว็บ แล้วค่อยใช้ตัวแกะคนละชุด ส่วนการจับคู่ทำต่อที่ฝั่งหน้าเว็บ
 * เพราะเป็นตรรกะล้วน ๆ และผู้ใช้ต้องสลับคู่เองได้โดยไม่ต้องอัปโหลดใหม่
 */
